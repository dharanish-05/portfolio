...
__all__ = [
    'DISPID_SGRSTNextState', 'SREStateChange', 'SVEPrivate',
    'SPADAPTATIONRELEVANCE', 'SAFTCCITT_ALaw_22kHzStereo',
    'SDTLexicalForm', 'DISPID_SPRules_NewEnum', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRIsUISupported', 'SLOStatic', 'SPAUDIOSTATE',
    'DISPID_SRGRules', 'SVP_11', 'SpeechGrammarWordType',
    'SAFTExtendedAudioFormat',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPPS_Interjection',
    'ISpeechLexiconPronunciation', 'SPRECORESULTTIMES',
    'ISpeechVoice', 'SVP_5', 'DISPID_SRRecognizer',
    'SPSERIALIZEDPHRASE', 'DISPID_SABIBufferSize', 'SPAR_Unknown',
    'DISPID_SLGenerationId', 'ISpRecoResult', 'SpeechRecoEvents',
    'SREInterference', 'SpeechAddRemoveWord', 'SP_VISEME_17',
    'ISpeechRecoGrammar', 'DISPID_SPPName', 'SPWT_DISPLAY',
    'SPEI_RESERVED5', 'SAFTADPCM_44kHzMono', 'DISPID_SDKEnumValues',
    'eLEXTYPE_USER_SHORTCUT', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRRPhraseInfo', 'SVP_18', 'ISpeechMMSysAudio',
    'SPFM_CREATE', 'IInternetSecurityMgrSite',
    'DISPID_SpeechGrammarRule', 'SVSFlagsAsync',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SAVolume', 'DISPID_SLPsItem',
    'SDA_No_Trailing_Space', 'SPVPRI_NORMAL',
    'DISPID_SASCurrentDevicePosition', 'SpeechAudioFormatGUIDWave',
    'ISpEventSink', 'ISpeechMemoryStream',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SGRSTsItem',
    '_ISpeechVoiceEvents', 'SRAONone', 'DISPID_SpeechAudioFormat',
    'SRADefaultToActive', 'SGDSActive', 'DISPID_SLPLangId',
    'ISpeechPhraseProperties', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechBaseStream', 'DISPID_SPIStartTime',
    'DISPID_SpeechCustomStream', 'DISPID_SRCEHypothesis', 'SPAS_RUN',
    'SRADynamic', 'DISPID_SLWWord', 'SVEViseme',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SDKSetBinaryValue',
    'ISpDataKey', 'DISPID_SpeechGrammarRules',
    'DISPID_SLPPartOfSpeech', 'SSFMOpenForRead', 'DISPID_SPCLangId',
    'eWORDTYPE_DELETED', 'DISPID_SLPType', 'DISPID_SOTCategory',
    'DISPIDSPTSI', 'SPEI_RESERVED1', 'SVP_3', 'SP_VISEME_15',
    'DISPID_SRCEAudioLevel', 'SPEI_START_SR_STREAM',
    'SPEI_PROPERTY_STRING_CHANGE', 'SAFT44kHz16BitMono', 'STCAll',
    'DISPID_SABufferNotifySize', 'SAFT32kHz8BitStereo',
    'DISPID_SLWsItem', 'DISPIDSPTSI_ActiveOffset',
    'SPFM_OPEN_READONLY', 'eLEXTYPE_RESERVED10', 'SVSFIsNotXML',
    'ISpRecoContext', 'DISPID_SVGetVoices', 'SVP_8',
    'ISpeechPhraseInfoBuilder', 'DISPID_SpeechRecoContextEvents',
    'SGDSActiveUserDelimited', 'DISPID_SOTRemove',
    'SPDKL_DefaultLocation', 'SAFT16kHz8BitStereo', 'SAFTDefault',
    'SAFT32kHz16BitMono', 'DISPID_SpeechRecoResult2',
    'SPPHRASEELEMENT', 'SPXMLRESULTOPTIONS', 'SBONone',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRGDictationLoad',
    'DISPID_SOTCGetDataKey', 'DISPID_SPRuleEngineConfidence',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVP_15', 'SPGS_ENABLED',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRCRequestedUIType',
    'eLEXTYPE_RESERVED9', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechLexiconWord', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVEViseme', 'SECFIgnoreCase', 'DISPID_SVGetProfiles',
    'SpeechGrammarTagUnlimitedDictation', 'SPEVENT',
    'SAFTADPCM_11kHzStereo', 'SAFTADPCM_44kHzStereo',
    'SAFT12kHz8BitStereo', 'DISPID_SRSCurrentStreamPosition',
    'SPWT_LEXICAL', 'DISPID_SVEEnginePrivate', 'SWTDeleted',
    'SPBO_TIME_UNITS', 'ISpeechRecognizerStatus',
    'SpeechVoiceSpeakFlags', 'SPRS_INACTIVE',
    'ISpeechAudioBufferInfo', 'SAFTADPCM_11kHzMono',
    'DISPID_SRCEAdaptation', 'SPEI_SOUND_START',
    'DISPID_SPERetainedSizeBytes', 'SECFEmulateResult',
    'DISPID_SRSCurrentStreamNumber', 'SINone',
    'ISpeechPhraseElements', 'SITooSlow', 'DISPID_SPELexicalForm',
    'DISPID_SRRDiscardResultInfo', 'SAFT24kHz8BitStereo',
    'SPPS_Modifier', 'ISpStreamFormat', 'DISPID_SBSWrite',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SBOPause', 'SPPS_RESERVED4',
    'ISpeechRecoResult', 'eLEXTYPE_PRIVATE13', 'DISPID_SVEPhoneme',
    'SPEI_RECO_OTHER_CONTEXT', 'SPVISEMES', 'SECFIgnoreWidth',
    'ISpRecoGrammar', 'DISPID_SRCRecognizer',
    'DISPID_SpeechGrammarRuleState', 'SPEI_END_SR_STREAM',
    'SPEI_PHONEME', 'SpeechSpecialTransitionType',
    'eLEXTYPE_PRIVATE3', 'SPRECOSTATE', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVRate', 'DISPID_SOTCDefault',
    'SpeechCategoryAppLexicons', 'SPAR_High', 'SSTTTextBuffer',
    'SAFTADPCM_8kHzStereo', 'DISPIDSPRG',
    'DISPID_SPEDisplayAttributes', 'SpeechRegistryUserRoot',
    'SAFT11kHz16BitMono', 'ISpShortcut', 'SPVOICESTATUS',
    'DISPID_SBSFormat', 'ISpeechObjectToken',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRCRetainedAudioFormat',
    ...
    'DISPID_SABufferInfo', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpTextSelectionInformation', 'eLEXTYPE_PRIVATE2', 'SVP_2',
    'SpeechGrammarTagDictation', 'DISPID_SVSkip',
    'SpeechEmulationCompareFlags', 'SVP_17', 'SRERequestUI',
    'SP_VISEME_0', 'DISPID_SVEBookmark', 'DISPID_SDKGetlongValue',
    'DISPID_SPPChildren', 'SpeechGrammarTagWildcard',
    'DISPID_SBSRead', 'SP_VISEME_13',
    'DISPID_SVSInputSentencePosition', 'SVSFPersistXML',
    'DISPID_SPRuleParent', 'SPEI_RESERVED6', 'SVP_10',
    'SpeechCategoryPhoneConverters',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SpeechObjectToken',
    'DISPID_SRProfile', 'DISPID_SASFreeBufferSpace',
    'SpeechDiscardType', 'SVEAudioLevel', 'SPGS_EXCLUSIVE',
    'SPEI_RESERVED2', 'DISPID_SLPPhoneIds', 'SPCT_DICTATION',
    'ISpeechLexiconWords', 'SP_VISEME_6', 'ISequentialStream',
    'ISpeechRecoResult2', 'SPEI_UNDEFINED', 'eLEXTYPE_PRIVATE10',
    'SpeechVisemeFeature', 'SPPROPERTYINFO', 'SpAudioFormat',
    'SPPS_Verb', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRCSetAdaptationData', 'SVSFParseSapi',
    'DISPID_SMSAMMHandle', 'DISPID_SRGIsPronounceable',
    'SVEAllEvents', 'DISPID_SOTs_NewEnum', 'SPRECOCONTEXTSTATUS',
    'SPINTERFERENCE_TOOFAST', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPFILEMODE', 'SVP_0', 'SPEVENTSOURCEINFO', 'DISPID_SPAsCount',
    'SPGRAMMARSTATE', 'WAVEFORMATEX', 'SDTProperty',
    'DISPID_SpeechFileStream', 'SECFDefault',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEI_MIN_TTS',
    'DISPID_SpeechAudioStatus', 'SPPARTOFSPEECH',
    'SpeechEngineConfidence', 'SPAS_PAUSE', 'DISPID_SPRulesCount',
    'DISPID_SGRSAddWordTransition', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SAStatus', 'DISPID_SREmulateRecognition',
    'DISPID_SPANumberOfElementsInResult', 'SpNotifyTranslator',
    'SPWORDPRONUNCIATION', 'SAFTGSM610_11kHzMono', 'DISPID_SOTSetId',
    'SRSActive', 'SPBO_NONE', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPPsCount', 'SpeechAudioState', 'SpStream',
    'SPLEXICONTYPE', 'SPPS_RESERVED3', 'SPEI_HYPOTHESIS',
    'DISPID_SPEsCount', 'SAFT48kHz8BitStereo',
    'DISPID_SVSInputSentenceLength', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPCIdToPhone', 'ISpeechAudio', 'SpeechTokenKeyFiles',
    'SPSHT_NotOverriden', 'SpeechGrammarRuleStateTransitionType',
    'SVSFIsXML', 'SPEI_TTS_BOOKMARK', 'SPEI_MAX_TTS',
    'DISPID_SWFEFormatTag', 'SVP_9', 'DISPID_SABIEventBias',
    'SpeechPropertyComplexResponseSpeed',
    'ISpeechLexiconPronunciations', '_RemotableHandle',
    'DISPID_SLGetPronunciations', 'SVEVoiceChange', 'SP_VISEME_8',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRGetRecognizers',
    'DISPID_SDKGetStringValue', 'SINoise',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SOTsItem', 'DISPID_SVEWord',
    'SVEPhoneme', 'SVF_Stressed', 'SPAR_Low',
    'DISPID_SpeechPhoneConverter', 'DISPID_SpeechVoice',
    'DISPID_SRRGetXMLResult', 'DISPID_SPARecoResult',
    'ISpRecoContext2', 'ISpNotifyTranslator', 'SPSInterjection',
    'SpeechPropertyResponseSpeed', 'Speech_StreamPos_RealTime',
    'ISpAudio', 'SpeechRecoProfileProperties',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SGRsFindRule',
    'DISPID_SpeechMemoryStream', 'SAFT32kHz16BitStereo',
    'SGRSTTWildcard', 'SPCT_SLEEP', 'SAFT11kHz8BitMono',
    'DISPID_SPPNumberOfElements', 'DISPID_SRRRecoContext',
    'DISPID_SRCERecognition', 'SDTPronunciation',
    'SpeechEngineProperties', 'SPAS_STOP', 'SPWT_PRONUNCIATION',
    'DISPID_SpeechAudioBufferInfo', 'SAFT16kHz8BitMono',
    'DISPID_SRCreateRecoContext', 'SECFIgnoreKanaType',
    'SRESoundStart', 'DISPID_SVGetAudioInputs', 'SRSEIsSpeaking',
    'SDKLDefaultLocation', 'DISPID_SLGetGenerationChange',
    'DISPID_SVDisplayUI', 'SRTExtendableParse', 'SVP_19',
    'SpStreamFormatConverter', 'DISPID_SRRTLength', 'SRAInterpreter',
    'eLEXTYPE_USER', 'DISPID_SVAlertBoundary', 'SpCustomStream',
    'SAFTGSM610_8kHzMono', 'DISPID_SDKDeleteKey',
    'DISPID_SRSetPropertyNumber', 'ISpeechAudioStatus',
    'SPFM_CREATE_ALWAYS', 'ISpeechPhoneConverter', 'DISPID_SGRSTText',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SWFEChannels',
    'SpeechPropertyHighConfidenceThreshold', 'LONG_PTR',
    'DISPID_SRCESoundEnd', 'DISPID_SRGState', 'SpInProcRecoContext',
    'DISPID_SGRSTPropertyValue', 'SAFTCCITT_ALaw_44kHzMono',
    'SP_VISEME_4', 'SDTAudio', 'SpVoice', 'DISPID_SGRsCount',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SpeechDataKey',
    'DISPID_SOTDataKey', 'DISPID_SRCBookmark', 'SPAR_Medium',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPRNumberOfElements',
    'DISPID_SLWLangId', 'SpPhraseInfoBuilder', 'ISpLexicon',
    'DISPID_SLWs_NewEnum', 'SGLexical',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVEAudioLevel',
    'SpeechPartOfSpeech', 'DISPID_SDKEnumKeys', 'DISPID_SPPs_NewEnum',
    'SASClosed', 'DISPID_SPIElements', 'SRTAutopause',
    'SREPhraseStart', 'SAFTCCITT_ALaw_11kHzStereo',
    'Speech_Default_Weight', 'SPEI_REQUEST_UI', 'SPRS_ACTIVE',
    'SPPS_LMA', 'SAFT12kHz16BitMono', 'DISPID_SRSetPropertyString',
    'DISPID_SRGId', 'DISPID_SLPs_NewEnum', 'SDKLLocalMachine',
    'SAFT22kHz8BitMono', 'SPCS_DISABLED', 'SPAO_NONE',
    'SAFT48kHz16BitStereo', 'DISPID_SpeechObjectTokens',
    'DISPID_SBSSeek', 'SAFTGSM610_44kHzMono', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPRulesItem', 'DISPID_SPPParent', 'DISPID_SGRSTs_NewEnum',
    'SAFTADPCM_8kHzMono', 'SRSInactiveWithPurge', 'ISpEventSource',
    'SPRULESTATE', 'DISPID_SLPSymbolic', 'SPVPRI_OVER',
    'ISpeechPhraseRules', 'SRSInactive', 'SPEVENTENUM',
    'DISPID_SVSPhonemeId', 'DISPID_SRGSetTextSelection',
    'ISpeechXMLRecoResult', 'SVSFDefault', 'SPWORDLIST',
    'DISPID_SRCERecognitionForOtherContext', 'SPBO_AHEAD',
    'ISpeechDataKey', 'DISPID_SPACommit', 'ISpSerializeState',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SASCurrentSeekPosition', 'SPSNotOverriden',
    'SPAUDIOBUFFERINFO', 'SPEI_TTS_PRIVATE',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRRTStreamTime',
    'DISPID_SPERequiredConfidence', 'SPEI_INTERFERENCE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPSHT_EMAIL',
    'ISpeechPhraseReplacement', 'SPVPRIORITY', 'SAFT44kHz8BitStereo',
    'SpeechPropertyLowConfidenceThreshold', 'STSF_CommonAppData',
    'DISPID_SGRId', 'DISPID_SRGDictationSetState',
    ...
    'DISPID_SRCRetainedAudio', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPIRule',
    'eLEXTYPE_PRIVATE6', 'SP_VISEME_5', 'SVSFNLPSpeakPunc',
    'SPEI_RECO_STATE_CHANGE', 'SREAllEvents',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPPHRASE', 'SFTSREngine',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SVEStreamStart', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SGRInitialState', 'SAFT32kHz8BitMono',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVSLastBookmark',
    'SPPS_Unknown', 'SpeechAudioFormatType', 'SPPS_Noun',
    'SGDSInactive', 'DISPID_SGRSTType', 'SpeechLexiconType',
    'SPINTERFERENCE', 'SITooQuiet', 'SPINTERFERENCE_NONE',
    'SpeechDisplayAttributes', 'SASRun', 'DISPID_SLPsCount',
    'DISPID_SRRAlternates', 'DISPID_SpeechXMLRecoResult',
    'SP_VISEME_7', 'ISpGrammarBuilder', 'ISpeechPhraseReplacements',
    'SPFM_OPEN_READWRITE', 'SpShortcut', 'SPPS_NotOverriden',
    'DISPID_SPPsItem', 'DISPID_SASState',
    'DISPID_SpeechLexiconPronunciation', 'SP_VISEME_1',
    'SRERecognition', 'DISPID_SWFEBlockAlign', 'DISPID_SGRsAdd',
    'SGRSTTWord', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRCResume',
    'DISPID_SGRSTPropertyId', 'SpeechWordPronounceable',
    'Speech_Max_Pron_Length', 'DISPID_SRDisplayUI',
    'DISPID_SpeechRecoResult', 'SPRULE', 'SPAUDIOOPTIONS', 'SVP_14',
    'SP_VISEME_12', 'DISPID_SRGCmdLoadFromObject',
    'SpeechTokenShellFolder', 'SAFTGSM610_22kHzMono',
    'DISPID_SGRSTPropertyName', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPEEngineConfidence', 'SPRST_NUM_STATES',
    'SAFT12kHz16BitStereo', 'DISPID_SVSpeakStream',
    'DISPID_SABIMinNotification', 'DISPID_SpeechRecoContext',
    'eLEXTYPE_PRIVATE19', 'ISpeechObjectTokens', 'eLEXTYPE_RESERVED8',
    'SSTTWildcard', '_SPAUDIOSTATE', 'SPBOOKMARKOPTIONS',
    'STCLocalServer', '_ISpeechRecoContextEvents',
    'DISPID_SPIGrammarId', 'DISPID_SOTId', 'SPEI_SR_RETAINEDAUDIO',
    'SVP_12', 'SREAdaptation', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpeechVoiceStatus', 'DISPID_SRCVoice', 'SAFT11kHz8BitStereo',
    'SRSActiveAlways', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SADefaultFormat', 'SSFMCreateForWrite', 'SPXRO_SML',
    'SVEBookmark', 'SVP_13', 'SpeechDictationTopicSpelling',
    'eLEXTYPE_RESERVED7', 'DISPID_SpeechMMSysAudio',
    'SPRST_ACTIVE_ALWAYS', 'SpeechRecognitionType',
    'DISPID_SRRAudioFormat', 'DISPID_SMSSetData', 'SPVPRI_ALERT',
    'DISPID_SOTMatchesAttributes', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechPhraseReplacements', 'STSF_AppData',
    'DISPID_SVSInputWordPosition', 'DISPID_SRCCreateGrammar',
    'DISPID_SPRuleName', 'SPAS_CLOSED', 'ISpeechWaveFormatEx',
    'DISPID_SRSClsidEngine', 'DISPID_SRCEFalseRecognition',
    'DISPID_SDKOpenKey', 'DISPID_SGRs_NewEnum',
    'ISpPhoneticAlphabetConverter', 'SPAUDIOSTATUS',
    'SpeechVoiceCategoryTTSRate', 'SRTStandard',
    'SpeechCategoryVoices', 'DISPID_SVEVoiceChange', 'SP_VISEME_10',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRCState',
    'SPEI_RECOGNITION', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRCEventInterests', 'SRTEmulated', 'DISPID_SPPValue',
    'SpeechRecognizerState', 'SAFT24kHz16BitStereo', 'SpLexicon',
    'DISPID_SPRuleFirstElement', 'SpPhoneticAlphabetConverter',
    'DISPID_SDKSetStringValue', 'ISpPhoneConverter',
    'DISPID_SGRAttributes', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpRecoGrammar2',
    'DISPID_SpeechAudio', 'SASStop', 'DISPID_SGRAddResource',
    'SRCS_Enabled', 'DISPID_SMSGetData',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpStream',
    'SAFT8kHz8BitMono', 'DISPID_SGRsDynamic', 'SAFTNonStandardFormat',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVSRunningState',
    'ISpNotifySource', 'SDKLCurrentUser', 'DISPID_SRGetFormat',
    'SpeechGrammarState', 'SPCT_COMMAND', 'SPDATAKEYLOCATION',
    'SpSharedRecognizer', 'SRARoot', 'SPRS_ACTIVE_USER_DELIMITED',
    'SVEWordBoundary', 'IEnumSpObjectTokens', 'ISpVoice',
    'SAFT22kHz16BitStereo', 'ISpStreamFormatConverter',
    'ISpeechObjectTokenCategory', 'DISPID_SMSADeviceId',
    'eLEXTYPE_PRIVATE7', 'DISPID_SVESentenceBoundary',
    'SpeechCategoryRecoProfiles', 'eLEXTYPE_PRIVATE20',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRGetPropertyNumber',
    'tagSTATSTG', 'SGRSTTDictation', 'SpeechCategoryRecognizers',
    'DISPID_SVStatus', 'DISPID_SGRClear',
    'DISPID_SPAStartElementInResult', 'SPSUnknown',
    'DISPID_SOTCSetId', 'SPPHRASEREPLACEMENT', 'SP_VISEME_14',
    'SPPS_RESERVED2', 'DISPID_SOTDisplayUI',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPSHORTCUTPAIR',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechGrammarRules',
    'DISPID_SPCPhoneToId', 'SINoSignal', 'SpeechFormatType',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVSInputWordLength',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRCEPropertyStringChange',
    'SDA_One_Trailing_Space', 'ISpeechRecoResultTimes',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPDKL_CurrentUser', 'SVF_None', 'Speech_StreamPos_Asap',
    'ISpeechPhraseAlternates', 'DISPID_SPRDisplayAttributes',
    'ISpObjectToken', 'SVSFNLPMask', 'SVSFParseSsml',
    'SVSFIsFilename', 'ISpeechRecoContext',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPIProperties',
    'DISPID_SPEs_NewEnum', 'SpeechBookmarkOptions', 'SASPause',
    'DISPIDSPTSI_SelectionLength', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRCERequestUI', 'DISPID_SGRSAddRuleTransition',
    'SWPKnownWordPronounceable', 'SPCATEGORYTYPE',
    'ISpeechGrammarRuleState', 'SPGS_DISABLED',
    'SGDSActiveWithAutoPause', 'SPSNoun', 'SAFT24kHz8BitMono',
    'SPPS_RESERVED1', 'DISPID_SVSVisemeId',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPRFirstElement', 'DISPID_SVSCurrentStreamNumber',
    'SRESoundEnd', 'SWTAdded', 'SSFMCreate', 'SP_VISEME_11',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechTokenKeyUI',
    'DISPID_SLWPronunciations', 'DISPID_SpeechLexiconProns',
    'SVEStartInputStream', 'SGSDisabled',
    'DISPID_SpeechPhraseProperties', 'SPSFunction', 'ISpPhraseAlt',
    'SPEI_VISEME', 'DISPID_SPISaveToMemory', 'SGRSTTRule',
    'DISPID_SRRAudio', 'DISPID_SPRuleNumberOfElements',
    'SAFT22kHz16BitMono', 'DISPID_SPIEngineId', 'SPSERIALIZEDRESULT',
    'DISPID_SLAddPronunciation', 'DISPID_SOTRemoveStorageFileName',
    'SpCompressedLexicon', 'SPRST_ACTIVE', 'SP_VISEME_21',
    'SPSHORTCUTTYPE', 'DISPID_SOTGetDescription',
    'SECFNoSpecialChars', 'SGDisplay', 'SPLO_STATIC', 'SLODynamic',
    'DISPID_SpeechVoiceEvent', 'SDKLCurrentConfig', 'SpObjectToken',
    'SpPhoneConverter', 'DISPID_SPPFirstElement', 'STCRemoteServer',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPSModifier',
    'SpeechStreamFileMode', 'SPEI_ADAPTATION', 'eLEXTYPE_PRIVATE15',
    'SpeechRetainedAudioOptions', 'SPINTERFERENCE_TOOLOUD',
    'SpInprocRecognizer', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SGRAddState', 'SPEI_SR_PRIVATE', 'ISpResourceManager',
    'Speech_Max_Word_Length', 'SPSSuppressWord', 'DISPID_SAFType',
    'SWPUnknownWordPronounceable', 'IInternetSecurityManager',
    'DISPID_SPPId', 'ISpRecognizer2', 'SPDKL_LocalMachine',
    'DISPID_SAFSetWaveFormatEx', 'SECLowConfidence',
    'DISPID_SGRSTransitions', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SOTsCount', 'DISPID_SPIEnginePrivateData',
    'SRERecoOtherContext', 'DISPID_SLGetWords', 'DISPID_SMSALineId',
    'SSSPTRelativeToStart', 'ISpeechPhraseAlternate',
    'ISpeechLexiconWord', 'ISpProperties', 'SSSPTRelativeToEnd',
    'SAFTText', 'SVP_7', 'SRTSMLTimeout', 'SDTReplacement',
    'DISPID_SGRName', 'SpeechRunState', 'DISPID_SRCCmdMaxAlternates',
    'eWORDTYPE_ADDED', 'DISPID_SFSOpen', 'SPSEMANTICERRORINFO',
    'SVSFParseMask', 'SVP_16', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPIAudioSizeTime', 'SpMMAudioOut', 'DISPID_SPRuleId',
    'SVEEndInputStream', 'DISPID_SpeechPhraseRule', 'SpeechWordType',
    'DISPID_SRAudioInput', 'eLEXTYPE_PRIVATE9', 'ISpeechFileStream',
    'DISPID_SRCEInterference', 'SGSEnabled', 'DISPID_SDKDeleteValue',
    'SVSFPurgeBeforeSpeak', 'STSF_FlagCreate',
    'DISPID_SPEDisplayText', 'ISpeechRecognizer',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SGRSTTEpsilon',
    'DISPID_SRCPause', 'UINT_PTR', 'DISPID_SPPEngineConfidence',
    'SAFT16kHz16BitMono', 'SPCS_ENABLED', 'SRATopLevel',
    'SpeechTokenIdUserLexicon', 'DISPID_SRGDictationUnload',
    'DISPID_SPPConfidence', 'SPCT_SUB_COMMAND',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SpeechVoiceStatus',
    'SPWF_SRENGINE', 'SPLOADOPTIONS', 'SPRST_INACTIVE',
    'ISpRecognizer', 'SPPS_Noncontent', 'SREStreamEnd', 'SPSLMA',
    'eLEXTYPE_APP', 'SPEI_RESERVED3', 'SAFTNoAssignedFormat',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPRECOGNIZERSTATUS',
    'SGLexicalNoSpecialChars', 'DISPID_SVSpeak', 'SVP_1',
    'DISPID_SGRSTsCount', 'SAFTCCITT_ALaw_8kHzStereo',
    'SpWaveFormatEx', 'SPCONTEXTSTATE', 'ISpeechLexicon',
    'DISPID_SPIRetainedSizeBytes', 'SVF_Emphasis', 'SDTAlternates',
    'DISPID_SPEPronunciation', 'SAFTCCITT_uLaw_44kHzStereo',
    'SRSEDone', 'SRCS_Disabled', 'SPEI_VOICE_CHANGE', 'SVPAlert',
    'DISPID_SRState', 'STCInprocHandler', '__MIDL_IWinTypes_0009',
    'SAFT12kHz8BitMono', 'ISpeechResourceLoader',
    'DISPID_SRRTTickCount', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SVIsUISupported', 'SpeechCategoryAudioIn',
    'DISPID_SVPriority', 'DISPID_SRGCommit',
    'ISpeechTextSelectionInformation', 'ISpeechPhraseElement',
    'DISPID_SVResume', 'SPPS_SuppressWord', 'STSF_LocalAppData',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SWFEAvgBytesPerSec', 'IStream', 'SPWORDPRONOUNCEABLE',
    'SAFT48kHz8BitMono', 'SECHighConfidence',
    'DISPID_SRCEEnginePrivate', 'SPSVerb', 'SpFileStream',
    'SPPS_Function', 'DISPID_SPRs_NewEnum', 'SPSMF_UPS',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechRecoResultDispatch', 'eLEXTYPE_PRIVATE17',
    'SVSFParseAutodetect', 'SPBINARYGRAMMAR', 'SpeechDataKeyLocation',
    'DISPID_SPRsCount', 'DISPID_SGRsItem', 'SpeechMicTraining',
    'SpeechVoicePriority', 'SpObjectTokenCategory', 'SPLO_DYNAMIC',
    'SPWAVEFORMATTYPE', 'SpeechPropertyResourceUsage',
    ...
    'SGPronounciation', 'DISPID_SRCEBookmark',
    'DISPID_SpeechRecognizerStatus', 'SpeechAudioFormatGUIDText',
    'SVPOver', 'SPSHT_Unknown', 'DISPID_SAFGuid',
    'SpeechCategoryAudioOut', 'SpeechAudioVolume',
    'DISPID_SpeechPhraseAlternates', 'SPEI_SR_AUDIO_LEVEL',
    'eLEXTYPE_RESERVED4', 'SPAO_RETAIN_AUDIO', 'DISPID_SVVolume',
    'DISPID_SOTIsUISupported', 'SLTApp', 'SpeechTokenValueCLSID',
    'SREStreamStart', 'DISPID_SRIsShared', 'SpeechVisemeType',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SGRSRule',
    'DISPID_SpeechLexiconWords', 'SpeechRecoContextState',
    'DISPID_SRStatus', 'SAFT44kHz16BitStereo',
    'SpUnCompressedLexicon', 'SPDKL_CurrentConfig', 'SGSExclusive',
    'SPBO_PAUSE', 'SPEI_SENTENCE_BOUNDARY',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRCEEndStream',
    'SpResourceManager', 'SAFT11kHz16BitStereo', 'SAFT44kHz8BitMono',
    'SAFT8kHz8BitStereo', 'SRAORetainAudio', 'SPEI_FALSE_RECOGNITION',
    'ISpeechPhraseRule', 'SP_VISEME_19', 'SAFT8kHz16BitStereo',
    'SAFTADPCM_22kHzMono', 'SAFTADPCM_22kHzStereo', 'SITooLoud',
    'SpSharedRecoContext', 'DISPID_SASNonBlockingIO',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_MIN_SR', 'SpMMAudioIn',
    'SPCT_SUB_DICTATION', 'SpeechRegistryLocalMachineRoot',
    'ISpeechPhraseInfo', 'SPFM_NUM_MODES',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRRTimes',
    'DISPID_SVAudioOutputStream', 'SP_VISEME_3',
    'ISpeechCustomStream', 'SPWORDTYPE', 'SPPHRASERULE',
    'SVESentenceBoundary', 'DISPID_SFSClose',
    'DISPID_SGRsCommitAndSave', 'DISPID_SASetState',
    'SPTEXTSELECTIONINFO', 'SSFMOpenReadWrite',
    'SAFTCCITT_uLaw_11kHzMono', 'STCInprocServer', 'DISPID_SGRSTRule',
    'DISPID_SOTGetAttribute', 'DISPID_SPEAudioSizeTime',
    'SPEI_PHRASE_START', 'ISpeechPhraseProperty',
    'SREFalseRecognition', 'IEnumString', 'SpeechAudioProperties',
    'SPEI_MAX_SR', 'SpNullPhoneConverter', 'SVP_6', 'SPWF_INPUT',
    'DISPID_SPRText', 'SpeechVoiceEvents', 'SpeechRuleAttributes',
    'DISPID_SPIGetText', 'DISPID_SpeechLexicon', 'SREBookmark',
    'DISPID_SPIReplacements', 'DISPID_SRRSaveToMemory',
    'DISPID_SLWType', 'SVP_4', 'SDA_Consume_Leading_Spaces',
    'SPSEMANTICFORMAT', 'SPWORD', 'eLEXTYPE_PRIVATE16',
    'DISPID_SWFEBitsPerSample', 'SPXRO_Alternates_SML',
    'DISPID_SGRSTWeight', 'SVPNormal', 'DISPID_SVPause', 'SLTUser',
    'SAFT48kHz16BitMono', 'eLEXTYPE_PRIVATE8', 'DISPID_SPAPhraseInfo',
    'DISPID_SVVoice', 'SRAExport', 'DISPID_SPAsItem',
    'DISPID_SPRuleChildren', 'DISPID_SpeechPhraseRules',
    'DISPID_SVAudioOutput', 'DISPID_SRCEPhraseStart', 'SDTAll',
    'SDTRule', 'DISPID_SRGetPropertyString', 'DISPID_SLWsCount',
    'ISpeechBaseStream', 'SVSFUnusedFlags', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPAs_NewEnum', 'SREPropertyNumChange', 'SREPrivate',
    'DISPID_SVSLastBookmarkId', 'DISPID_SVGetAudioOutputs',
    'SRAImport', 'DISPID_SVSLastStreamNumberQueued',
    'ISpObjectTokenCategory', 'ISpRecognizer3', 'DISPID_SOTCId',
    'SREPropertyStringChange', 'SSTTDictation', 'SpeechInterference',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SVWaitUntilDone',
    'SDTDisplayText', 'SpeechRuleState',
    'DISPID_SPEAudioStreamOffset', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SVEStreamEnd', 'SAFT22kHz8BitStereo', 'SpMemoryStream',
    'ISpXMLRecoResult', 'SPGRAMMARWORDTYPE',
    'DISPID_SPPBRestorePhraseFromMemory', 'SP_VISEME_2',
    'eLEXTYPE_PRIVATE1', 'SFTInput', 'SVP_20',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SpeechRecognizer',
    'SpeechLoadOption', 'DISPID_SDKSetLongValue',
    'DISPID_SRGCmdLoadFromFile', 'SDA_Two_Trailing_Spaces',
    'eLEXTYPE_RESERVED6', 'SITooFast', 'SPINTERFERENCE_NOISE',
    'SP_VISEME_20', 'DISPID_SPEActualConfidence',
    'SECNormalConfidence', 'ISpeechAudioFormat', 'ISpObjectWithToken',
    'DISPID_SVEventInterests', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SpeechPhraseElements', 'DISPID_SRAudioInputStream',
    'SGRSTTTextBuffer', 'DISPID_SRGCmdLoadFromMemory',
    'SAFT24kHz16BitMono', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRGReset', 'ISpPhrase', 'SpeechUserTraining',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SCSBaseStream',
    'ISpRecoCategory', 'DISPID_SGRsCommit', 'DISPID_SAEventHandle',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SpeechPhraseInfo', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRRSpeakAudio', 'SP_VISEME_18', 'ISpNotifySink',
    'tagSPPROPERTYINFO', 'DISPID_SOTGetStorageFileName',
    'SPPHRASEPROPERTY', 'DISPID_SVSpeakCompleteEvent',
    'SREHypothesis', 'SpMMAudioEnum', 'DISPID_SDKCreateKey',
    'DISPID_SRGRecoContext', 'DISPID_SPEsItem', 'SPSHT_OTHER',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRGCmdSetRuleIdState',
    'SP_VISEME_16', 'DISPID_SPRsItem', 'SpeechAllElements', 'SVP_21',
    'SpeechTokenKeyAttributes', 'SPEI_SOUND_END',
    'DISPID_SRSNumberOfActiveRules', 'SRTReSent',
    'DISPID_SRCESoundStart', 'SVSFVoiceMask',
    'DISPID_SpeechPhraseElement', 'SpeechTokenContext',
    'SpeechPropertyAdaptationOn', 'DISPID_SWFEExtraData',
    'DISPID_SPRuleConfidence', 'DISPID_SRRSetTextFeedback',
    'ISpMMSysAudio', 'SAFTCCITT_uLaw_22kHzMono', 'ISpeechGrammarRule',
